...
from poseydon.preproc.raw_bvh import (
...
# (relative path, expected root name, expected joint count). Verified by
# direct inspection of these exact files -- see the design spec's §3.
PILOT_RAW_CLIPS = [
